...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("ul", {
    ...
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      ...
      key: 1,
      item: processedItem.item,
      isActive: $options.isItemActive(processedItem),
      hasSubmenu: $options.isItemGroup(processedItem),
      label: $options.getItemLabel(processedItem),
      props: $options.getMenuItemProps(processedItem, index)
    }, null, 8, ["item", "isActive", "hasSubmenu", "label", "props"]))], 16, _hoisted_3$1), vue.createVNode(vue.Transition, vue.mergeProps({
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      ...
      key: 1,
      item: item,
      isActive: $options.isItemActive(item),
      hasSubmenu: $options.getItemProp(item, 'items'),
      label: $options.getItemLabel(item),
      props: $options.getMenuItemProps(item, index)
    }, null, 8, ["item", "isActive", "hasSubmenu", "label", "props"]))], 16)], 16, _hoisted_2), vue.createVNode(vue.Transition, vue.mergeProps({
      name: "p-toggleable-content"
    }, _ctx.ptm('transition')), {
      "default": vue.withCtx(function () {
        return [vue.withDirectives(vue.createElementVNode("div", vue.mergeProps({
